...
### [/03-input-output /05-reflection.md](https://github.com/neurothrone/python-for-ai/blob/main/week-01-intro-python-ai/03-input-output/05-reflection.md): 05. Reflection Input and Output (repetitionsfrågor)
